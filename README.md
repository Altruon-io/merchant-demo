<p align="center">
  <a href="https://www.altruon.io">
    <img src="client/public/altruon/logo.svg" alt="Altruon" width="220" />
  </a>
</p>

<h1 align="center">Altruon Merchant Demo</h1>

<p align="center">
  A complete, production-shaped reference integration of the
  <a href="https://docs.altruon.io/docs/developers/altruon-js/quick-start">Altruon JS SDK</a>:
  a branded SaaS subscription checkout with live tax &amp; discount estimation,
  redirect / QR payment flows, and a post-payment transaction report.
</p>
...
**Prerequisites:** Node.js ≥ 20.19, an Altruon sandbox account with
a billing provider connected (Stripe, Chargebee, Recurly, …) and a payment
gateway routed for your currency.
